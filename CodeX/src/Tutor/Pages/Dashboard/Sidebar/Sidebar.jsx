...
const Sidebar = ({ activeItem, setActiveItem }) => {
  ...
  return (
    <div
      className={`text-white p-5 transition-all ${
        open ? "w-26" : "w-26"
    ...
    >
      ...
      <div className="flex items-center justify-between relative z-10">
        <h2
          className={`text-4xl font-extrabold transition-all text-white ${
            open ? "block" : "hidden"
          }`}
        >
          Dashboard
      ...
      <nav className="mt-6 relative z-10">
        <ul className="space-y-4">
          <SidebarItem
            ...
            className="text-white hover:text-white hover:bg-white transition duration-200 px-4 py-2 rounded-md"
          />
          <SidebarItem
