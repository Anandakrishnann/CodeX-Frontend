...
const Lessons = () => {
  ...
  const toggle_status = async (e, id) => {
    ...
    try {
      ...
      toast.error(error?.response?.data?.detail || "Error While Updating Status");
      console.error(error);
    }
  };
            ...
            <>
              ...
              <div className="mb-2 bg-gradient-to-br from-cyan-900/40 to-purple-800/40 p-6 rounded-3xl shadow-2xl relative">
                <div className="flex justify-between items-start flex-wrap">
                  ...
                  <div>
                    <button
                      className="text-xl font-bold px-5 py-2 mr-40 bg-white text-black rounded-lg border-2 border-white hover:bg-black hover:text-white hover:border-white transition-all duration-300"
                    ...
                    <button
                      className="text-xl font-bold px-5 py-2 ml-24 mt-2 bg-white text-black rounded-lg border-2 border-white hover:bg-black hover:text-white hover:border-white transition-all duration-300"
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-2xl relative w-full max-w-2xl max-h-full overflow-y-auto border border-gray-200 dark:border-gray-700 animate-slideUp">
              ...
              <div className="mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                <div className="bg-gradient-to-r from-black to-blue-500 text-transparent bg-clip-text">
                  <h2 className="text-3xl font-extrabold mb-1">Create Lesson</h2>
                </div>
        ...
        {isEditModalOpen && (
          <div className="fixed inset-0 font-sans bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 transition-all duration-300 animate-fadeIn">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-2xl relative w-full max-w-2xl max-h-full overflow-y-auto border border-gray-200 dark:border-gray-700 animate-slideUp">
              ...
              <div className="mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                <div className="bg-gradient-to-r from-black to-blue-500 text-transparent bg-clip-text">
                  <h2 className="text-3xl font-extrabold mb-1">Edit Lesson</h2>
                </div>
                <p className="text-gray-500 dark:text-gray-400">
