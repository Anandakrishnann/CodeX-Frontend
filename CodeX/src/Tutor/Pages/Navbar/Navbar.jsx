...
const Navbar = () => {
  ...
  return (
    <nav
      className={cn(
        "fixed top-0 left-0 w-full z-50 transition-all duration-300 ease-in-out bg-transparent",
        scrolled
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-4 text-lg">
            <div className="relative">
              <input
                type="text"
                className="px-4 py-2 text-white bg-gray-900/70 border border-gray-700 rounded-lg w-54 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all"
                placeholder="Search courses..."
              />
              <button className="absolute right-0 top-0 h-full px-3 flex items-center justify-center text-green-500 hover:text-green-500 hover:text-white transition-all">
                <svg
            ...
            <button
              ...
              onClick={() => navigate("/")}
            >
              <span className="relative z-10 text-xl">User</span>
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-green-500 group-hover:w-full transition-all duration-300"></span>
            </button>
            ...
            >
              <span className="relative z-10 text-xl">Notifications</span>
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-green-500 group-hover:w-full transition-all duration-300"></span>
            </button>
