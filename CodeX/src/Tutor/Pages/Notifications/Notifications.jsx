            ...
            <div className="min-h-screen flex flex-col bg-black">
                ...
                <div className="flex-1 flex flex-col md:flex-row px-6 py-4">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col items-center justify-start pt-8">
                        <h2 className="text-white text-4xl font-bold mb-6">Notifications</h2>
                        <div className="w-full relative">
                            <input type="text" placeholder="Search" className="w-full bg-white rounded-lg py-3 px-10 text-black" />
                ...
                <div className="bg-gray-200 flex-1 px-6 py-8 rounded-t-3xl">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="flex justify-between items-center mb-6">
                            <button className="w-1/2 bg-gray-900 text-white py-3 px-4 rounded-md text-center">Search</button>
                                ...
                                <tbody>
                                    <tr className="border-b border-gray-300">
                                        ...
                                        <td className="py-6 px-4">
                                            <span className="bg-green-100 text-green-600 px-4 py-1 rounded-full">Approved</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="py-6 px-4">-</td>
                                        <td className="py-6 px-4">
                                            <span className="bg-red-100 text-red-600 px-4 py-1 rounded-full">Blocked</span>
                                        </td>
                                        <td className="py-6 px-4">15/09/2024</td>
                                    </tr>
                                </tbody>
