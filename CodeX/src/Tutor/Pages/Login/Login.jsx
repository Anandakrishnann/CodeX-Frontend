  ...
  return (
    ...
    <div className="h-screen overflow-hidden flex">
      <div className="w-1/2 bg-black">
        <img className="w-full h-full object-cover" src="https://i.pinimg.com/736x/b7/84/c6/b784c69e68438962d492143b87b6cb3b.jpg" alt="Login background" />
      </div>
      <div className="w-1/2 bg-black flex justify-center items-center">
        <div className="w-full max-w-md p-8  rounded-lg shadow-lg">
          <h2 className="text-5xl font-bold mb-3 text-white text-start">Welcome Back.</h2>
