...
const Overview = () => {
  ...
  const acceptApplication = async (applicationId) => {
    ...
    try {
        await adminAxios.post(`/accept/${applicationId}/`);
    ...
    const rejectApplication = async (applicationId) => {
        try {
            await adminAxios.post(`/reject/${applicationId}/`);
        ...
        <div className="mx-auto px-4 py-8 font-serif" style={{width: "1100px"}}>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="p-6 flex justify-between items-center border-b border-gray-200">
                                ...
                                <button style={{backgroundColor: userData.status === "pending" ? "#ffd700" : userData.status === "accepted" ? "green" : userData.status === "rejected"? "red" : "black"}} className=" text-black font-extrabold text-xl px-4 py-2 rounded-md flex items-center gap-2">
                            ...
                            <div className="flex justify-center space-x-2 mb-6">
                                ...
                                {userData.status === "pending" ? (
                                    ...
                                    <button style={{ backgroundColor: "red" }} className="text-white px-4 py-2 rounded-md flex items-center gap-2" >
                                    <CloseIcon className="h-4 w-4" />
                                    <span>Rejected</span>
                                    </button>
                                ):null}
