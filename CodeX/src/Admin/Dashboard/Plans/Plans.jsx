...
const Plans = () => {
        ...
        <Layout>
          <div className="grid  gap-6">
              ...
              <div className="row-span-1 p-4 rounded-lg ">
                ...
                <button className="text-xl bg-green-500 p-1 rounded-md font-extrabold m-3 border border-white hover:text-black hover:bg-white hover:border-green-500 hover:border-2" style={{width:"100px", marginLeft:"610px"}} onClick={() => setIsModalOpen(true)}>Create</button>

                </div>
                <div className="text-3xl font-extrabold m-4">
                  <h1>Active Plans <TrendingUpIcon fontSize="large"/></h1>
                </div>
                ...
                >
                  ...
                  <div>
                    <div className="mb-4">
                      ...
                      <p className="text-sm text-gray-300 uppercase tracking-wider">{data.plan_type}</p>
                    </div>
                    <div className="mb-4">
                  ...
                  <div className="mt-auto pt-2">
                    <h2 className="text-4xl font-bold text-green-300">₹{data.price}</h2>
                  </div>
                </div>
  ...
  <div className="fixed inset-0 font-serif bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md relative" style={{ height: "600px" }}>
      <button
      ...
      <div className="mb-3">
        ...
        <input name="price" type="number" step="0.01" className="w-full p-2 mt-1 text-black border border-gray-300 rounded-lg bg-gray-100" onChange={handleChange}/>
      </div>
