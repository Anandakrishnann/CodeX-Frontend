      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        <div className="col-span-3 grid grid-rows-3 gap-6">
          ...
          <div className="bg-gray-800 p-4 rounded-lg">
              <h2 className="text-lg font-semibold mb-4">Total Amount <span className="text-sm text-gray-400">All Time</span></h2>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span>Profit</span><span className="text-purple-400">$400.00</span>
                </div>
                <div className="flex justify-between">
                  <span>Loss</span><span className="text-purple-400">$900.00</span>
                </div>
              </div>
              <div className="mt-4">
      ...
      />
          ...
          <div className="row-span-1 bg-gray-800 p-4 rounded-lg">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="w-1/2">
                <p>Corporate Card <span className="text-purple-400">$2,600.00</span></p>
                <p>Debit Card <span className="text-purple-400">$5,832.00</span></p>
                <p>Cash <span className="text-purple-400">$900.00</span></p>
              </div>
            </div>
          </div>
          ...
          <div className="row-span-1 grid grid-cols-2 gap-6">
            ...
            {/* Active Customers */}
            <div className="bg-gray-800 p-4 rounded-lg">
              <h2 className="text-lg font-semibold mb-4">Active Customers <span className="text-sm text-gray-400">Inactive</span></h2>
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <img src="https://via.placeholder.com/30" alt="Olivia Rhys" className="w-8 h-8 rounded-full" />
                  <div>
                    <p>Olivia Rhys</p>
                ...
                <div className="flex items-center space-x-2">
                  <img src="https://via.placeholder.com/30" alt="Phoenix Baker" className="w-8 h-8 rounded-full" />
                  <div>
                    <p>Phoenix Baker</p>
                ...
                <div className="flex items-center space-x-2">
                  <img src="https://via.placeholder.com/30" alt="Candice Wu" className="w-8 h-8 rounded-full" />
                  <div>
                    <p>Candice Wu</p>
