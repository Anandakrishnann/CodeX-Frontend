            ...
            <div className="mb-8 flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400">
                  Review and verify tutor credentials
                </p>
              </div>
              <div className="flex items-center gap-4">
                {userData.is_blocked ? (
                  <div
                    className={`bg-gradient-to-r from-red-600 to-rose-700 hover:from-red-700 hover:to-rose-800 text-white px-6 py-3 rounded-2xl shadow-2xl flex items-center gap-3 transform hover:scale-105 transition-all duration-300`}
                  >
                    <RotateCcw size={18} />
