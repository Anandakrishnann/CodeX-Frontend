                      ...
                      <div className="p-6 border-b border-gray-100">
                        ...
                        >
                          {meeting.left === meeting.limit
                            ? "Full"
                            : `${meeting.limit - meeting.left} spots left`}
                        </span>
                      </div>
                      ...
                      <div className="p-6 pt-0">
                        {role === "tutor" && isSubscribed === true ? (
                          <div className="flex gap-2">
                            ...
                            <button className="flex-1 border-2 border-gray-200 text-gray-700 py-2 px-4 rounded-lg hover:border-red-500 hover:text-red-500 flex justify-center">
