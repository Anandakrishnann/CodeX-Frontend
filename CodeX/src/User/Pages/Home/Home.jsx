    ...
    <div className="min-h-screen relative overflow-hidden font-poppins">
      ...
      <div className="container mx-auto px-4 pt-32 md:pt-40 relative z-10">
        <motion.div className="text-center" initial="hidden" animate="visible" variants={fadeIn}>
          <h1 className="md:text-7xl font-bold mb-10" style={{marginTop: "55px"}}>
          ...
          {popularCourses.map((course) => (
            ...
            >
              ...
              <Button
                ...
                className="w-full bg-transparent hover:bg-green-500 border border-green-500 text-white mt-4 transition-colors"
              >
                View Course
              </Button>
            </motion.div>
      ...
      >
        <motion.h2 
          ...
          variants={fadeIn}
        >
          Why Choose <span className="text-white">Code</span><span className="text-green-500">X</span>
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="bg-codex-green/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-25 w-25 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-gray-400">Learn by doing with our hands-on coding exercises and real-time feedback.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-white text-xl font-semibold mb-2">Expert Curriculum</h3>
            <p className="text-gray-400">Courses designed by industry professionals to teach you relevant skills.</p>
          </motion.div>
