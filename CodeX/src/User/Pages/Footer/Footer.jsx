      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 ml-8">
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2 text-gray-400">
            <li><a href="#" className="hover:text-white">Инфо</a></li>
            <li><a href="#" className="hover:text-white">Състояние</a></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2 text-gray-400">
            <li><a href="#" className="hover:text-white">Работни места</a></li>
            <li><a href="#" className="hover:text-white">Брандиране</a></li>
            <li><a href="#" className="hover:text-white">Ножинарско студио</a></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2 text-gray-400">
            <li><a href="#" className="hover:text-white">Поддържка</a></li>
            <li><a href="#" className="hover:text-white">Безопасност</a></li>
            <li><a href="#" className="hover:text-white">Блог</a></li>
            <li><a href="#" className="hover:text-white">Обратна връзка</a></li>
            <li><a href="#" className="hover:text-white">StreamKit</a></li>
            <li><a href="#" className="hover:text-white">Създатели</a></li>
            <li><a href="#" className="hover:text-white">Community</a></li>
            <li><a href="#" className="hover:text-white">Изградждай</a></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-3">
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li><a href="#" className="hover:text-white">Настройки за бисквитки</a></li>
            <li><a href="#" className="hover:text-white">Насоки</a></li>
            <li><a href="#" className="hover:text-white">Благодарности</a></li>
            <li><a href="#" className="hover:text-white">Лицензи</a></li>
